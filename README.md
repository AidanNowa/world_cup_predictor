...
### Monte Carlo Win Probabilities - Top 20 (10,000 simulations)
...
<details>
<summary><b>Click to expand all 12 groups</b></summary>
...
### Predicted Bracket with Most Likely Outcomes
> Each match is decided by whichever team has the higher P(win) from the Poisson model

***Group Stage Results***

<details>
<summary><b>Click to expand predicted group standings</b></summary>

 | Group A | P | W | D | L | GF | GA | GD | Pts |
|---------|---|---|---|---|----|----|----|-----|
| ✓ Mexico | 3 | 3 | 0 | 0 | 6 | 3 | +3 | 9 |
| ✓ South Korea | 3 | 2 | 0 | 1 | 5 | 4 | +1 | 6 |
| Czechia | 3 | 1 | 0 | 2 | 4 | 5 | -1 | 3 |
...
> **Winner: Spain** · Runner-up: England · Third place: Morocco & Argentina
...
*Built with Python · scipy · pandas · tqdm*
